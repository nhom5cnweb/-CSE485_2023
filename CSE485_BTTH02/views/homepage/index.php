...
<head>
    ...
    <link rel="stylesheet" href="css/style_login.css"> <!-- Kết nối đến CSS tùy chỉnh -->
</head>
<body>
    <header>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="index.php?controller=author&action=index">Tác giả</a> <!-- Đã sửa liên kết tác giả -->
                        </li>
                        <li class="nav-item">
    ...
    <main class="container mt-5 mb-5">
        <div class="row">
            <!-- Thẻ card cho thông tin tổng quan -->
            <div class="col-sm-3">
